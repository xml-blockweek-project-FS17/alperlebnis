...
>
    ...
    <xsl:variable name="total" select="sum(//bookings/booking/paidprice)" />

    <xsl:variable name="maxCost" select="number(//booking/paidprice[not(. &lt; //booking/paidprice)][1])" />
    <xsl:variable name="maxCost" select="number(//bookings/booking/paidprice[not(. &lt; //booking/paidprice)][1])" />
